"""Create synthetic screenshots, video, and JUnit failure for alarm testing."""
...
Call log:
  - This verbose text must not appear in the email.
  - This verifies that the alert summarizer removes the full Playwright log.

Aria snapshot:
  - This accessibility snapshot must not appear in the email.
      </failure>
    </testcase>
  </testsuite>
</testsuites>
...
def create_browser_evidence(
    ...
    with sync_playwright() as playwright:
        ...
        # Context closure finalizes the WebM video file.
        context.close()
        browser.close()
...
def main() -> int:
    ...
    parser.add_argument(
        "--monitor",
        default=(
            "Peoples Clinic Alarm Delivery Test"
        ),
    )
